...
abstract class ARKitAnchor {
  ...
  factory ARKitAnchor.fromJson(Map<String, dynamic> arguments) {
    ...
    switch (type) {
      ...
      case 'objectAnchor':
        return ARKitObjectAnchor.fromJson(arguments);
      default:
...
class ARKitPlaneAnchor extends ARKitAnchor {
  ...
  static ARKitPlaneAnchor fromJson(Map<String, dynamic> json) => _$ARKitPlaneAnchorFromJson(json);
...
class ARKitImageAnchor extends ARKitAnchor {
  ...
  static ARKitImageAnchor fromJson(Map<String, dynamic> json) => _$ARKitImageAnchorFromJson(json);
...
class ARKitFaceAnchor extends ARKitAnchor {
  ...
  static ARKitFaceAnchor fromJson(Map<String, dynamic> json) =>
      _$ARKitFaceAnchorFromJson(json..putIfAbsent('geometry', () => <String, dynamic>{}));
...
class ARKitBodyAnchor extends ARKitAnchor {
  ...
  static ARKitBodyAnchor fromJson(Map<String, dynamic> json) => _$ARKitBodyAnchorFromJson(json);
...
class ARKitObjectAnchor extends ARKitAnchor {
  ...
  static ARKitObjectAnchor fromJson(Map<String, dynamic> json) => _$ARKitObjectAnchorFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$ARKitObjectAnchorToJson(this);
}
