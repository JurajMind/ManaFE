...
func createWorldTrackingConfiguration(_ arguments: Dictionary<String, Any>) -> ARWorldTrackingConfiguration? {
    if(ARWorldTrackingConfiguration.isSupported) {
        ...
        if #available(iOS 12.0, *) {
            ...
            let referenceImages = ARReferenceObject.referenceObjects(inGroupNamed: trackingImagesGroupName, bundle: nil) {
            worldTrackingConfiguration.detectionObjects = referenceImages
        }
