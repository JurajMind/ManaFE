...
func serializeAnchor(_ anchor: ARAnchor) -> Dictionary<String, Any> {
    ...
    if let objectAnchor = anchor as? ARObjectAnchor {
        params = serializeObjectAnchor(objectAnchor, params)
    }
...
fileprivate func serializeObjectAnchor(_ anchor: ARObjectAnchor, _ params:[String : Any]) -> [String : Any]{
    var params = params
    params["anchorType"] = "objectAnchor"
    if let referenceObjectName = anchor.referenceObject.name {
        params["referenceObjectName"] = referenceObjectName
    }
    let referenceObjectCenter = anchor.referenceObject.center 
    params["center"] = serializeArray(referenceObjectCenter)
      let referenceObjectExtend = anchor.referenceObject.extent 
    params["extent"] = serializeArray(referenceObjectExtend)
