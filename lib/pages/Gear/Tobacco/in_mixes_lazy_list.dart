...
class InMixesLazyList extends StatefulWidget {
  ...
  const InMixesLazyList({Key? key, this.tobacco, this.initInMixes}) : super(key: key);
...
class _InMixesLazyListState extends State<InMixesLazyList> {
  ...
  Future<dynamic> loadMoreMixes(List<TobaccoMixSimpleDto?> mixes, {bool refresh = false}) async {
  ...
  @override
  void initState() {
    inMixes = new BehaviorSubject<List<TobaccoMixSimpleDto?>?>.seeded(widget.initInMixes);
    super.initState();
  }
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (item == null) {
                          ...
                          return MixCardExpanded(tobaccoMix: snapshot.data![index], highlightId: widget.tobacco!.id);
                        }
                      }),
                );
              }),
