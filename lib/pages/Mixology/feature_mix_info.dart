...
class FeatureMixInfo extends StatelessWidget {
  ...
  const FeatureMixInfo({Key? key, this.creatorInfo, this.simple}) : super(key: key);
      ...
      child: Column(
        children: <Widget>[
          StreamBuilder<FeatureMixCreatorDto>(
            stream: creatorInfo,
            initialData: null,
            builder: (BuildContext context, AsyncSnapshot<FeatureMixCreatorDto> snapshot) {
              ...
              return Container(
                child: Column(
                  children: <Widget>[
                    ...
                    !MPlatform.isWeb
                        ? new Image(
                            image: new CachedNetworkImageProvider(snapshot.data!.logoPicture!),
                            fit: BoxFit.cover,
                            height: 150)
                        : Image.network(
