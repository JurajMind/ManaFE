        ...
        slivers: <Widget>[
         ...
         bottom: PreferredSize(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: <Widget>[
                Text('Smoking hedgehog',style: Theme.of(context).textTheme.display1,),
                    Text('Lvl: 4',style: Theme.of(context).textTheme.display1,)
              ],),
         ),
          ),
           new SliverList(
            delegate: SliverChildListDelegate([
              ...
              Row(
                ...
                children: <Widget>[
                                    Row(
                                      children: <Widget>[
                                        Icon(Icons.star),
                                        Text('450/1000 exp',style: Theme.of(context).textTheme.display2)
                                      ],
                                    ),
                                     Row(
                                      children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  Text('Achievments 5/200',style: Theme.of(context).textTheme.display1,),
                    SizedBox(
                height: 10,
              ),
               AchievementItem(
