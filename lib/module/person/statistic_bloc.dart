...
class StatisticBloc {
  ...
  loadStatistic(DateTime from, DateTime to) async {
    ...
    var statistic = this.getDisplayStatistic(from, to, result.smokeSessions,month: true);
    topGraphData.add(statistic);
  }

  List<StatisticItem> getDisplayStatistic(DateTime from, DateTime to,   List<SmokeSessionSimpleDto> statistic, {bool month = false }){
