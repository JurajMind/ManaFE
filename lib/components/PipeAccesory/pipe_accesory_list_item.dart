    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: SizedBox(
            ...
            width: 60.0,
            child:
                Hero(tag: '_picture', child: Extensions.accesoryPicture(pipeAccesory))),
        title: Text(this.pipeAccesory.name,style: Theme.of(context).textTheme.display2),
        subtitle: Text(pipeAccesory.brand,style: Theme.of(context).textTheme.display3),
      ),
    );
  }
}
