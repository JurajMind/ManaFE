...
class HorizontalMapCarousel extends StatefulWidget {
  final PlaceSimpleDto selectedPlace;

  HorizontalMapCarousel({this.nearbyPlaces, this.mapController, this.selectedPlace});
...
class _CarrousselState extends State<HorizontalMapCarousel> {
  _CarrousselState();
  ...
  @override
  void didUpdateWidget(HorizontalMapCarousel oldWidget) {
