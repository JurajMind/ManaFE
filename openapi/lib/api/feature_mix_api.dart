...
class FeatureMixApi {
  ...
  Future featureMixAddFollow(int id) async {
    ...
    String path = "/api/FeatureMix/Follow/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future featureMixFix() async {
    ...
    // create path and map variables
    String path = "/api/FeatureMix/Fix".replaceAll("{format}","json");
  ...
  Future<FeatureMixCreatorDto> featureMixGetFeatureMixCreator(int id) async {
    ...
    // create path and map variables
    String path = "/api/FeatureMix/FeatureCreator/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<List<FeatureMixCreatorSimpleDto>> featureMixGetFeatureMixCreators({ int page, int pageSize, String orderBy, String order }) async {
    ...
    // create path and map variables
    String path = "/api/FeatureMix/FeatureCreators".replaceAll("{format}","json");
  ...
  Future<List<FeatureMixCreatorSimpleDto>> featureMixGetFollowedCreators() async {
    ...
    // create path and map variables
    String path = "/api/FeatureMix/FollowedCreators".replaceAll("{format}","json");
  ...
  Future<List<PipeAccesorySimpleDto>> featureMixGetMixes(int id, int page, int pageSize, String orderBy, String order) async {
    ...
    if(orderBy == null) {
     throw new ApiException(400, "Missing required param: orderBy");
    }
    if(order == null) {
    ...
    // create path and map variables
    String path = "/api/FeatureMix/Mixes/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
