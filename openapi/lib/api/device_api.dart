...
class DeviceApi {
  ...
  Future<DeviceSimpleDto> deviceChangeName(String id, String newName) async {
    ...
    // create path and map variables
    String path = "/api/Device/{id}/ChangeName".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<List<SmokeSessionSimpleDto>> deviceGetDeviceSessions(int id, { int pageSize, int page }) async {
    ...
    // create path and map variables
    String path = "/api/Device/{id}/Sessions".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
