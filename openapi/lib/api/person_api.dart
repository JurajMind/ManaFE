...
class PersonApi {
  ...
  Future personAddNotificationToken(String token) async {
    ...
    // create path and map variables
    String path = "/api/Person/NotificationToken".replaceAll("{format}","json");
  ...
  Future<List<SmokeSessionSimpleDto>> personGetPersonSessions() async {
    ...
    // create path and map variables
    String path = "/api/Person/Sessions".replaceAll("{format}","json");
  ...
  Future personTestNotification() async {
    ...
    // create path and map variables
    String path = "/api/Person/TestNotification".replaceAll("{format}","json");
