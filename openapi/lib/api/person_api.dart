...
class PersonApi {
  ...
  Future<PipeAccesorySimpleDto> personAddMyGear(int id, { int count }) async {
    ...
    String path = "/api/Person/MyGear/{id}/Add".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<SmokeSessionSimpleDto> personAssignSession(int id) async {
    ...
    // create path and map variables
    String path = "/api/Person/AssignSession/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<bool> personUnAssignSession(int id) async {
    ...
    // create path and map variables
    String path = "/api/Person/UnAssignSession/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
