...
class MediaApi {
  ...
  ///
  /// 
  Future<MediaDto> mediaAddReviewPicture(int id, MultipartFile file) async {
    Object postBody;
    ...
    // create path and map variables
    String path = "/api/Media/Review/{id}/Add".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
