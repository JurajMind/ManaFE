...
class SmokeSessionApi {
  ...
  ///
  /// 
  Future<int> smokeSessionEndSmokeSession(String id) async {
    Object postBody;
  ...
  Future<FinishedSessionDataDto> smokeSessionGetFinishedData(int id) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'FinishedSessionDataDto') as FinishedSessionDataDto;
    } else {
      return null;
    }
  }
  ...
  Future<SmokeSessionMetaDataDto> smokeSessionGetMetaData(String id) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'SmokeSessionMetaDataDto') as SmokeSessionMetaDataDto;
    } else {
      return null;
    }
  }
  ...
  Future<List<SmartHookahModelsDbPuf>> smokeSessionGetPufs(int id) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return (apiClient.deserialize(response.body, 'List<SmartHookahModelsDbPuf>') as List).map((item) => item as SmartHookahModelsDbPuf).toList();
    } else {
      return null;
    }
  }
  ...
  Future<InitDataDto> smokeSessionInitData(String id) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'InitDataDto') as InitDataDto;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<SmokeSessionMetaDataDto> smokeSessionSaveMetaData(String id, SmokeSessionMetaDataDto smokeSessionMetaDataDto) async {
    Object postBody = smokeSessionMetaDataDto;

    // verify required params are set
    if(id == null) {
     throw new ApiException(400, "Missing required param: id");
    }
    if(smokeSessionMetaDataDto == null) {
     throw new ApiException(400, "Missing required param: smokeSessionMetaDataDto");
    }
  ...
  Future<Validation> smokeSessionValidate(String id) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'Validation') as Validation;
    } else {
      return null;
    }
  }
