...
class DeviceSimpleDto {
  ...
  @override
  String toString() {
    return 'DeviceSimpleDto[name=$name, code=$code, isOnline=$isOnline, type=$type, version=$version,id=$id ]';
  }
  ...
  static List<DeviceSimpleDto> listFromJson(List<dynamic> json) {
    return json == null
        ...
        : json.map((value) => new DeviceSimpleDto.fromJson(value)).toList();
  }
  ...
  static Map<String, DeviceSimpleDto> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.length > 0) {
      json.forEach((String key, dynamic value) =>
          map[key] = new DeviceSimpleDto.fromJson(value));
    }
    return map;
  }
}
