...
class GearTobaccoReviewDto {
  ...
  @override
  String toString() {
    return 'GearTobaccoReviewDto[id=$id, cut=$cut, taste=$taste, smoke=$smoke, strength=$strength, duration=$duration, overall=$overall, text=$text, smokeSessionId=$smokeSessionId, ]';
  }
