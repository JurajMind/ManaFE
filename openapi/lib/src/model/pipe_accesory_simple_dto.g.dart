...
part of 'pipe_accesory_simple_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PipeAccesorySimpleDto _$PipeAccesorySimpleDtoFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'PipeAccesorySimpleDto',
      json,
      ($checkedConvert) {
        final val = PipeAccesorySimpleDto(
...
Map<String, dynamic> _$PipeAccesorySimpleDtoToJson(
    PipeAccesorySimpleDto instance) {
