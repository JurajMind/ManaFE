...
class TobaccoApi {
  ...
  Future<Response<TobaccoSimpleDto>> tobaccoGetTobacco({
    ...
    final _path = r'/api/Tobacco/{id}/GetTobacco'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<List<TobaccoMixSimpleDto>>> tobaccoGetTobaccoInMixes({
    ...
    final _path = r'/api/Tobacco/{id}/InMix'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TobaccoInformationDto>> tobaccoGetTobaccoInfo({
    ...
    final _path = r'/api/Tobacco/{id}/GetAllInfo'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PipeAccessoryStatisticsDto>> tobaccoGetTobaccoSatistics({
    ...
    final _path = r'/api/Tobacco/{id}/GetStatistics'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<SmokeSessionSimpleDto>>> tobaccoGetTobaccoSessions({
    ...
    final _path = r'/api/Tobacco/{id}/GetSessions'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<TobaccoTasteDto>>> tobaccoGetTobaccoTaste({
    ...
    final _path = r'/api/Tobacco/{id}/GetTaste'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<TobaccoDto>>> tobaccoSearch({
    ...
    final _path = r'/api/Tobacco/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'page': page,
      r'pageSize': pageSize,
      if (filterPeriodTastes != null) r'filter.tastes': filterPeriodTastes,
      if (filterPeriodSortBy != null) r'filter.sortBy': filterPeriodSortBy,
      if (filterPeriodBrand != null) r'filter.brand': filterPeriodBrand,
      if (filterPeriodOwned != null) r'filter.owned': filterPeriodOwned,
      if (filterPeriodSmoked != null) r'filter.smoked': filterPeriodSmoked,
      if (filterPeriodSortDirection != null) r'filter.sortDirection': filterPeriodSortDirection,
    };
