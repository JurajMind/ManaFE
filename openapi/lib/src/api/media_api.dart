...
class MediaApi {
  ...
  Future<Response<MediaDto>> mediaAddGearPicture({ 
    ...
    final _path = r'/api/Media/Gear/{id}/Add'.replaceAll('{' r'id' '}', id.toString());
...
_responseData = deserialize<MediaDto, MediaDto>(_response.data!, 'MediaDto', growable: true);
  ...
  Future<Response<MediaDto>> mediaAddPlacePicture({ 
    ...
    final _path = r'/api/Media/Place/{id}/Add'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = deserialize<MediaDto, MediaDto>(_response.data!, 'MediaDto', growable: true);
  ...
  Future<Response<MediaDto>> mediaAddPlaceReview({ 
    ...
    final _path = r'/api/Media/PlaceReview/{id}/Add'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = deserialize<MediaDto, MediaDto>(_response.data!, 'MediaDto', growable: true);
  ...
  Future<Response<MediaDto>> mediaAddSessionReview({ 
    ...
    final _path = r'/api/Media/TobaccoReview/{id}/Add'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
