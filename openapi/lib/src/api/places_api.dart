...
class PlacesApi {
  ...
  Future<Response<PlaceDto>> placesAddFlags({
    ...
    final _path = r'/api/Places/{placeId}/AddFlags'.replaceAll('{' r'placeId' '}', placeId.toString());
  ...
  Future<Response<void>> placesFixLocation({
    ...
    final _path = r'/api/Places/FixLocation';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlacesPlaceDashboardDto>> placesGetDashboardData({
    ...
    final _path = r'/api/Places/{placeId}/DashboardData'.replaceAll('{' r'placeId' '}', placeId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlaceDto>> placesGetPlaceInfo({
    ...
    final _path = r'/api/Places/GetPlaceInfo';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlaceMenuDto>> placesGetPlaceMenu({
    ...
    final _path = r'/api/Places/{id}/Menu'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Object>> placesImportPlaces({
    ...
    final _path = r'/api/Places/Import';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Object>> placesImportPlacesFromMap({
    ...
    final _path = r'/api/Places/ImportMap';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<NearbyPlacesDto>> placesSearchNearby({
    ...
    final _path = r'/api/Places/SearchNearby';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
