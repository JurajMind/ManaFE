...
class GearApi {
  ...
  Future<Response<BrandDto>> gearGetBrand({
    ...
    final _path = r'/api/Gear/Brand/{brandName}'.replaceAll('{' r'brandName' '}', brandName.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<String>>> gearGetBrandsPrefix({
    ...
    final _path = r'/api/Gear/Brands/{prefix}'.replaceAll('{' r'prefix' '}', prefix.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PipeAccessoryDetailsDto>> gearGetDetails({
    ...
    final _path = r'/api/Gear/{id}/Detail'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PipeAccesorySimpleDto>> gearInfo({
    ...
    final _path = r'/api/Gear/{id}/Info'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<SearchPipeAccessory>>> gearSearch({
    ...
    final _path = r'/api/Gear/Search/{search}'.replaceAll('{' r'search' '}', search.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<SmokeSessionSimpleDto>>> gearSessions({
    ...
    final _path = r'/api/Gear/{id}/Sessions'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Object>> gearVote({
    ...
    final _path = r'/api/Gear/{id}/Vote'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
