...
class PersonApi {
  ...
  Future<Response<PipeAccesorySimpleDto>> personAddMyGear({
    ...
    final _path = r'/api/Person/MyGear/{id}/Add'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<void>> personAddNotificationToken({
    ...
    final _path = r'/api/Person/NotificationToken';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<SmokeSessionSimpleDto>> personAssignSession({
    ...
    final _path = r'/api/Person/AssignSession/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<bool>> personDeleteMyGear({
    ...
    final _path = r'/api/Person/MyGear/{id}/Delete'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PersonActiveDataDto>> personGetPersonActiveData({
    ...
    final _path = r'/api/Person/InitData';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<DeviceSimpleDto>>> personGetPersonDevices({
    ...
    final _path = r'/api/Person/Devices';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<SmokeSessionSimpleDto>>> personGetPersonSessions({
    ...
    final _path = r'/api/Person/Sessions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<List<PipeAccesorySimpleDto>>> personMyGear({
    ...
    final _path = r'/api/Person/MyGear';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> personTestNotification({
    ...
    final _path = r'/api/Person/TestNotification';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<bool>> personUnAssignSession({
    ...
    final _path = r'/api/Person/UnAssignSession/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
