...
class PlaceCalendarApi {
  ...
  Future<Response<Dto>> placeCalendarCreatePlaceEventFromFacebook({
    ...
    final _path = r'/api/PlaceCalendar/CreateEventFromFacebook';
  ...
  Future<Response<Dto>> placeCalendarDeletePlaceDay({
    ...
    final _path = r'/api/PlaceCalendar/DeletePlaceDay';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Dto>> placeCalendarDeletePlaceEvent({
    ...
    final _path = r'/api/PlaceCalendar/DeletePlaceEvent';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlaceEventCollection>> placeCalendarFindEventsBy({
    ...
    final _path = r'/api/PlaceCalendar/FindEventsBy';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'endsBefore': endsBefore,
      if (privacyType != null) r'privacyType': privacyType,
    };
  ...
  Future<Response<PlaceCalendarDto>> placeCalendarGetPlaceCalendar({
    ...
    final _path = r'/api/PlaceCalendar/GetCalendar';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlaceDay>> placeCalendarGetPlaceDay({
    ...
    final _path = r'/api/PlaceCalendar/GetPlaceDay';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<PlaceEvent>> placeCalendarGetPlaceEvent({
    ...
    final _path = r'/api/PlaceCalendar/GetPlaceEvent';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Dto>> placeCalendarSavePlaceDay({
    ...
    final _path = r'/api/PlaceCalendar/SavePlaceDay';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Dto>> placeCalendarSavePlaceEvent({
    ...
    final _path = r'/api/PlaceCalendar/SavePlaceEvent';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
