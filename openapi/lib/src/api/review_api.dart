...
class ReviewApi {
  ...
  Future<Response<PlacesPlaceReviewDto>> reviewAddPlaceReview({
    ...
    final _path = r'/api/Review/Place/{id}'.replaceAll('{' r'id' '}', id.toString());
  ...
  Future<Response<SmartHookahModelsDbSessionDtoSessionReviewDto>> reviewAddSessionReview({
    ...
    final _path = r'/api/Review/Session/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GearTobaccoReviewDto>> reviewAddTobaccoReview({
    ...
    final _path = r'/api/Review/Tobacco/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GearTobaccoReviewDetailDto>> reviewTobaccoReviewDetail({
    ...
    final _path = r'/api/Review/Tobacco/{id}/Detail'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
